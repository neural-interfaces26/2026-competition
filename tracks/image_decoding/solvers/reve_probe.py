"""Baseline — frozen REVE encoder + ridge linear probe to the embedding.
...
(braindecode, pretrained) maps each window to an embedding; a multi-output
ridge head on the mean-pooled embedding regresses the target image embedding,
ranked by cosine retrieval in the objective. Only the head is trained — its
